...
const translations = {
    en: {
        ...
        isha: "Isha",
        calendar: "Calendar",
        calendar_note: "Click on Calendar and Install the App for Accurate and more options for Prayer Times.",
        platform: "Platform",
        resources: "Resources",
        legal: "Legal",
        privacy: "Privacy",
        ...
        cat_atheism: "Atheism",
        cat_idols: "Idol Worship",
        cat_christianity: "Christianity",
        cat_judaism: "Judaism",
        cat_fiqh: "Fiqh & Life",
        cat_logic: "Logic & Philosophy",
    ...
    bn: {
        ...
        calendar_note: "নির্ভুল সময় এবং নামাজের আরও অপশনের জন্য ক্যালেন্ডারে ক্লিক করে অ্যাপটি ইনস্টল করুন।",
        ...
        all_topics: "সব বিষয়",
        cat_atheism: "নাস্তিকতা",
        cat_idols: "মূর্তিপূজা",
        cat_christianity: "খ্রিস্টধর্ম",
        cat_judaism: "ইহুদি ধর্ম",
        cat_fiqh: "ফেকহ ও জীবন",
        cat_logic: "যুক্তি ও দর্শন",
